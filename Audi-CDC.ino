...
const uint8_t sLIST1[] PROGMEM = "AT#VU\r\n"; //

const uint8_t sLIST2[] PROGMEM = "LIST2\r\n"; //

const uint8_t sLIST3[] PROGMEM = "LIST3\r\n"; //

const uint8_t sLIST4[] PROGMEM = "AT#VD\r\n"; //
...
const uint8_t sIDENTIFY[] PROGMEM = "IDENTIFY\r\n"; //

const uint8_t sNEWLINE[] PROGMEM = "NEWLINE\r\n"; //

const uint8_t sDASH[] PROGMEM = "DASH\r\n"; //

const uint8_t sHEX[] PROGMEM = "HEX\r\n"; //

const uint8_t sVERSION[] PROGMEM = "VERSION\r\n"; //
